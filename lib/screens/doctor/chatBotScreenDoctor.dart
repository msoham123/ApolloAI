...
class myChatBotScreenDoctor extends StatefulWidget {
  myChatBotScreenDoctor({Key key, this.title}) : super(key: key);

  final String title;

  State<StatefulWidget> createState() => myChatBotStateDoctor();
}

class myChatBotStateDoctor extends State<myChatBotScreenDoctor> {
...
//    _populateCurrentUser(loggedInUser);
    _messages.add(
        ChatMessage(
            text: "Hi Doctor, how can I assist you today?",
            name: "Apollo",
            type: false
        )
    );
