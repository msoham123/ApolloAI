...
class ApolloAI extends StatefulWidget {
  @override
  _ApolloAIState createState() => _ApolloAIState();
}

class _ApolloAIState extends State<ApolloAI> {
  List _outputs;
  File _image;
  bool _loading = false;
            ...
            _outputs != null
              ...
              children: <Widget>[
                ...
                Text(
                  ...
                  style: TextStyle(
                      color: _outputs[0]["label"].toString() !=
                          "Normal"
                          ? Colors.red
                          : Colors.green,
                      fontSize: 50.0,
